...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("http://localhost:1010/register", formData);
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="relative bg-[#1e1e2e] bg-opacity-80 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden p-8 border border-[#2d3748]">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-[#e2e8f0]">Welcome CoolTech</h2>
          ...
          <div>
            ...
            <div className="text-center text-sm text-[#94a3b8]">
              ...
              <a href="/login" className="text-[#818cf8] hover:text-[#6366f1] transition-colors">
             Login 
              </a>
            </div>
          </form>
